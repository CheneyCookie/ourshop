...
<head>
	...
	$(function(){
		//var offset=$("#mydetail").offset();
		$(".btn_list").children("button").click(function(event){
			//alert(event.pageX)
			//alert(event.pageY)
...
<body>
			...
			<div class="container">			
				...
				<div id="unLogin" class="show">				
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="" data-toggle="modal" data-target="#registerModal"><a href="${ourshop }/admin_toLogin"><span class="glyphicon glyphicon-user"></span> 后台登录</a></li>
					</ul>					
				</div>
				</c:if>
				<c:if test="${!empty sessionScope.user}">
	...
	<!--
	 ...
	 -->
		...
		<div class="picMove container">
		<div id="myCarousel" class="carousel slide row" data-ride="carousel"  data-interval="4000">
			<ol class="carousel-indicators">
				<li data-target="#myCarousel" data-slide-to="0" class="active"><a href="javascript:;"></a></li>
				<li data-target="#myCarousel" data-slide-to="1"><a href="javascript:;"></a></li>
				<li data-target="#myCarousel" data-slide-to="2"><a href="javascript:;"></a></li>
			</ol>
		
			
			<div class="carousel-inner">
				<div class="item active">
					<img src="img/111.jpg" alt="第一张"/>
				</div>
				
				<div class="item">
					<img src="img/002.jpg" alt="第二张"/>
				</div>		
				
				<div class="item">
					<img src="img/222.jpg" alt="第三张"/>
				</div>
			</div>
		</div>	
	</div>		
...
<c:forEach items="${applicationScope.bigList }" var="list">
	...
	<footer id="footer">
		<div class="container">
			...
			<a href="javascript:;"><span>鸣谢列表 |</span></a>
			<a href="javascript:;"><span>团队主页</span></a>
